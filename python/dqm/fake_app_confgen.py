...
def generate(
    ...
    confcmd = mrccmd("conf", "INITIAL", "CONFIGURED",[
                ...
                ('dqmprocessor', dqmprocessor.Conf(
                        ...
                        sdqm_hist=dqmprocessor.StandardDQM(how_often=60, num_frames=50),
                        sdqm_mean_rms=dqmprocessor.StandardDQM(how_often=10, num_frames=100),
                        sdqm_fourier=dqmprocessor.StandardDQM(how_often=60 * 20, num_frames=100),
