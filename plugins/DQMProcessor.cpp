...
DQMProcessor::RequestMaker()
{
  ...
  FourierSum fouriersum("fft_sums_display", CHANNELS_PER_LINK  * m_link_idx.size(), m_link_idx, 1. / m_clock_frequency * TICKS_BETWEEN_TIMESTAMP, m_standard_dqm_fourier_sum.num_frames);
